<div class="form-group @if ($errors->has('first_ip')) has-error @endif">
    ...
    <div class="col-sm-10">
        {!! Form::text('first_ip', null, ['class' => 'form-control', 'data-lpignore' => 'true']) !!}
...
<div class="form-group @if ($errors->has('last_ip')) has-error @endif">
    ...
    <div class="col-sm-10">
        {!! Form::text('last_ip', null, ['class' => 'form-control', 'data-lpignore' => 'true']) !!}
...
<div class="form-group @if ($errors->has('contact_id')) has-error @endif">
    ...
    <div class="col-sm-10">
        {!! Form::select('contact_id', $contact_selection, $selected, ['class' => 'form-control', 'data-lpignore' => 'true']) !!}
...
<div class="form-group @if ($errors->has('description')) has-error @endif">
    ...
    <div class="col-sm-10">
        {!! Form::text('description', null, ['class' => 'form-control', 'data-lpignore' => 'true']) !!}
