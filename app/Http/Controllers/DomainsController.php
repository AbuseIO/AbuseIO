...
class DomainsController extends Controller {
	...
	public function store()
	{
        ...
        return Redirect::route('domains.index')->with('message', 'Domain has been created');
	}
	...
	public function update(Domain $domain)
	{
        ...
        return Redirect::route('domains.show', $domain->id)->with('message', 'Domain has been updated.');
	}
	...
	public function destroy(Domain $domain)
	{
        ...
        return Redirect::route('domains.index')->with('message', 'Domain has been deleted.');
	}
