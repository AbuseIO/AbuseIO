<div class="row">
    <div class="col-sm-6">
        <div class="form-group label-floating @if ($errors->has('first_name')) has-error @endif">
    ...
    <div class="col-sm-6">
        <div class="form-group label-floating @if ($errors->has('last_name')) has-error @endif">
...
<div class="form-group @if ($errors->has('disable')) has-error @endif">
    ...
    <div class="checkbox">
        <label>
            {!! Form::checkbox('disableddummy', true, $disabled_checked, ['data-lpignore' => 'true']) !!} {{ trans('misc.disabled') }}
        </label>
    </div>
...
<div class="form-group">
    ...
    {!! link_to_route('admin.users.index', trans('misc.button.cancel'), [ ], ['class' => 'btn btn-raised btn-default']) !!}
</div>
@section('extrajs')
    <script>
