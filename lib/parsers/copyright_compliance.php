...
/*
** Function: parse_copyright_compliance
** Parameters: 
...
*/
function parse_copyright_compliance($message) {

    $source = 'Copyright-Compliance';
    $type = 'ABUSE';
    ...
    } else if (preg_match('/\<\?xml.*\<\/Infringement\>/s',$message['body'],$regs)) {
        $xml = $regs[0];
    }
