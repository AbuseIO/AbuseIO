...
class AssignCommand extends Command
{
    ...
    protected $signature = 'permission:assign
                            {--permission= : The permission name or OD to assign }
    ...
    public function handle()
    {
        ...
        $validation = $permission->validateCreate($permissionadd);
        ...
        $this->info("The permission {$this->option('name')} has been created");
